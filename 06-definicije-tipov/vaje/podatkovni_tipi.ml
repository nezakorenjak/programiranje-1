...
let rec intbool_reverse =
       let rec intbool_reverse' acc = function                (*polimorfen tip je 'a*)
              | Nil -> acc
...
let update ({fire= fire2; frost; arcane} as counter) = function  (*tukaj frost pomeni frost= frost; tu mamo še kaj, sam ni razpakirano*)
